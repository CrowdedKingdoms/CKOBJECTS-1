...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Skelot|Animation")
	...
	UPROPERTY(BlueprintAssignable, meta = (DisplayName = "OnAnimationFinished"), Category = "Animation")
	...
	UPROPERTY(BlueprintAssignable, meta = (DisplayName = "OnAnimationNotify"), Category = "Animation")
